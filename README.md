# Forked React Slingshot!

Special thanks for Kent C Dodds and Cory House for their awesomeness
...
| [PostCSS](https://github.com/postcss/postcss) | PostCSS is a tool for transforming styles with JS plugins. These plugins can lint your CSS, support variables and mixins, transpile future CSS syntax, inline images, and more. | null |
